 ...
 *  Set `dark` to render the outer paths in white instead of --ink. */
export function Logo({ recording = false, dark = false }: { recording?: boolean; dark?: boolean }) {
  const fg = dark ? "#d4d4d8" : "var(--ink)";
  return (
    <svg
